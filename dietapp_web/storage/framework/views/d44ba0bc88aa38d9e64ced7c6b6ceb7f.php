<?php echo $__env->make('nav_bar', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    ...
    <script src="<?php echo e(asset('js/edit_pacient.js')); ?>"></script>

    <script>
        // global app configuration object
        var config = {
            routes: {
                zone_editar_pacient: "<?php echo e(route('pacient.edit')); ?>",
                zone_pacients: "<?php echo e(route('pacients')); ?>",
            },
            vars: {
                pacient: "<?php echo e($pacient->id); ?>",
            }
        };
    </script>
...
<div class="container">
        ...
        <form id="f_edit_pacient" method="POST">
            ...
            <div class="row form-group">
                <div class="col-6">
                    ...
                    <input type="text" class="form-control" id="pacient_name" name="pacient_name" value="<?php echo e($pacient->name_user); ?>" placeholder="Nom">
                </div>

                <div class="col-6">
                    <label for="pacient_cognoms">Cognoms</label><label class="text-danger">*</label>
                    <input type="text" class="form-control" id="pacient_cognoms" name="pacient_cognoms" value="<?php echo e($pacient->lastname_user); ?>" placeholder="Cognoms">
                </div>
            ...
            <div class="row form-group">
                <div class="col-6">
                    ...
                    <input type="email" class="form-control" id="pacient_email" name="pacient_email" value="<?php echo e($pacient->email_patient); ?>" placeholder="Email usuari">
                </div>

                <div class="col-6">
                    <label for="pacient_phone">Telèfon</label>
                    <input type="phone" class="form-control" id="pacient_phone" name="pacient_phone" value="<?php echo e($pacient->phone_patient); ?>" placeholder="Telèfon">
                </div>
            ...
            <div class="row form-group">
                ...
                <div class="col-6">
                    ...
                    <input type="email" class="form-control" id="pacient_address" name="pacient_address" value="<?php echo e($pacient->address_patient); ?>" placeholder="Adreça usuari">
                </div>
    ...
    </div><?php /**PATH C:\xampp\htdocs\Projecte3\dietapp_web\resources\views/pacient_edit.blade.php ENDPATH**/ ?>