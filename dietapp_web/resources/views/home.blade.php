    ...
    <div class="page">
        ...
        <div id="nav-container">
          ...
          <div id="nav-content" tabindex="0">
            <ul>
              <li><a href=""><i class="fa-solid fa-house"></i> Inici</a></li>
              <li><a href=""><i class="fa-solid fa-user-group"></i> Pacients</a></li>
              <li><a href=""><i class="fa-solid fa-utensils"></i> Dietes</a></li>
              <li><a href=""><i class="fa-solid fa-dumbbell"></i> Exercicis</a></li>
              <li><a href=""><i class="fa-solid fa-person-walking"></i> El meu perfil</a></li>
            </ul>
          </div>
        </div>
